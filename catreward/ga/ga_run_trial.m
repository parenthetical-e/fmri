...
% 
% - As my reward presentation in the task is less than 1 second
% I turned on nonlinear HRFs; however as epochs (subtrial events) cannot 
% be specified I am not sure nonlinear will do any good.
% In any case the only cost is that the code runs slightly slower....
%
...
% 5. max(Fe) and Max(Fd)
Inp.MaxFe = 20.1800; %<-- numerical approximation of Max(Fe)
	% 20.1800 from 'set_MaxFe_MO_design_1102012-1955.mat'
Inp.MaxFd = 61.0905; %<-- numerical approximation of Max(Fd)
	% 61.0905 from 'set_MaxFd_MO_design_1102012-2120.mat'
